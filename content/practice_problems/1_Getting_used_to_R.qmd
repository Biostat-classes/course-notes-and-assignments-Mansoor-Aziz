...
file)](../Primer_material/R_primer.R). You should also be comfortable
using Rstudio and github [(see help
file)](../Primer_material/Tools_overview.qmd).
...
The : means make a list from the bottom number to the top number that
includes all integers in the interval.
